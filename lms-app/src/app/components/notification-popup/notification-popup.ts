...
export class NotificationPopup implements OnInit, OnDestroy {
  ...
  protected getTypeIllustration(type: NotificationType): SafeHtml {
    const svgs: Record<NotificationType, string> = {
      ...
      PaymentDispute: `
        <svg class="w-6 h-6" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path d="M12 2L3 7v5c0 5.25 3.9 10.16 9 11.36C17.1 22.16 21 17.25 21 12V7L12 2z" fill="url(#popupDisputeShield)" stroke="#dc2626" stroke-width="1.5" stroke-linejoin="round"/>
          <path d="M12 8v4" stroke="#dc2626" stroke-width="2" stroke-linecap="round"/>
          <circle cx="12" cy="15" r="1" fill="#dc2626"/>
          <defs>
            <linearGradient id="popupDisputeShield" x1="3" y1="2" x2="21" y2="23" gradientUnits="userSpaceOnUse">
              <stop stop-color="#fee2e2"/>
              <stop offset="1" stop-color="#fca5a5"/>
            </linearGradient>
          </defs>
      ...
      PaymentDowntime: `
        <svg class="w-6 h-6" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path d="M10.29 3.86L1.82 18a2 2 0 001.71 3h16.94a2 2 0 001.71-3L13.71 3.86a2 2 0 00-3.42 0z" fill="url(#popupDowntimeWarn)" stroke="#d97706" stroke-width="1.5" stroke-linejoin="round"/>
          <path d="M12 9v4" stroke="#b45309" stroke-width="2" stroke-linecap="round"/>
          <circle cx="12" cy="17" r="1" fill="#b45309"/>
          <defs>
            <linearGradient id="popupDowntimeWarn" x1="2" y1="3" x2="22" y2="21" gradientUnits="userSpaceOnUse">
              <stop stop-color="#fef3c7"/>
              <stop offset="1" stop-color="#fde68a"/>
            </linearGradient>
          </defs>
      ...
      Settlement: `
        <svg class="w-6 h-6" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
          <rect x="3" y="10" width="18" height="11" rx="1.5" fill="url(#popupSettleBg)" stroke="#059669" stroke-width="1.5"/>
          ...
          <defs>
            <linearGradient id="popupSettleBg" x1="3" y1="10" x2="21" y2="21" gradientUnits="userSpaceOnUse">
              <stop stop-color="#d1fae5"/>
              <stop offset="1" stop-color="#a7f3d0"/>
            </linearGradient>
          </defs>
      ...
      ProductRoute: `
        <svg class="w-6 h-6" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <circle cx="19" cy="18" r="2.5" fill="url(#popupRouteGrad)" stroke="#2563eb" stroke-width="1.5"/>
          ...
          <defs>
            <linearGradient id="popupRouteGrad" x1="16.5" y1="15.5" x2="21.5" y2="20.5" gradientUnits="userSpaceOnUse">
              <stop stop-color="#dbeafe"/>
              <stop offset="1" stop-color="#93c5fd"/>
            </linearGradient>
          </defs>
