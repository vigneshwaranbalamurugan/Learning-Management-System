...
namespace LMSApi.DALLibrary.Migrations
{
    ...
    [Migration("20260715165943_AddLessonAiSummaries")]
    partial class AddLessonAiSummaries
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LMSApi.ModelLibrary.Models.LessonAiSummary", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.ToTable("LessonAiSummaries", (string)null);
                });
            ...
            modelBuilder.Entity("LMSApi.ModelLibrary.Models.UserRoles", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2026, 7, 15, 16, 59, 43, 462, DateTimeKind.Utc).AddTicks(4790),
                            Description = "Learner account",
                            RoleName = "Learner",
                            UpdatedAt = new DateTime(2026, 7, 15, 16, 59, 43, 462, DateTimeKind.Utc).AddTicks(4790)
                        },
                        new
                        {
                            Id = 2,
                        ...
                        {
                            Id = 3,
                            CreatedAt = new DateTime(2026, 7, 15, 16, 59, 43, 462, DateTimeKind.Utc).AddTicks(4800),
                            Description = "Admin account",
                            RoleName = "Admin",
                            UpdatedAt = new DateTime(2026, 7, 15, 16, 59, 43, 462, DateTimeKind.Utc).AddTicks(4800)
                        });
                });
            ...
            modelBuilder.Entity("LMSApi.ModelLibrary.Models.Users", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2026, 7, 15, 16, 59, 43, 462, DateTimeKind.Utc).AddTicks(1610),
                            ...
                            RoleId = 3,
                            UpdatedAt = new DateTime(2026, 7, 15, 16, 59, 43, 462, DateTimeKind.Utc).AddTicks(1610)
                        });
                });
            ...
            modelBuilder.Entity("LMSApi.ModelLibrary.Models.LessonAiSummary", b =>
                {
                    b.HasOne("LMSApi.ModelLibrary.Models.Lessons", "Lesson")
                        .WithOne()
                        .HasForeignKey("LMSApi.ModelLibrary.Models.LessonAiSummary", "LessonId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
