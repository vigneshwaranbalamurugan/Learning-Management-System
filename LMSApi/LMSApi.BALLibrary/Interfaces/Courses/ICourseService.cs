...
namespace LMSApi.BALLibrary.Interfaces
{
    public interface ICourseService
    {
        ...
        Task<CourseResponse> GetCourseBySlugAsync(string slug, int? currentUserId = null, bool isAdmin = false, string? view = null);
        ...
        Task<CourseResponse> StartCourseUpdateAsync(int courseId, int instructorId, StartCourseUpdateRequest request);
        ...
        Task<PagedCourseListResponse> GetUpdatesPendingCoursesPagedAsync(CourseSearchQuery query);
