...
namespace LMSApi.BALLibrary.Interfaces
{
    public interface IDiscussionService
    {
        ...
        Task<IEnumerable<DiscussionResponse>> GetLessonDiscussionsAsync(int lessonId, int userId);
        Task<DiscussionDetailResponse> GetDiscussionDetailAsync(int discussionId, int userId);
